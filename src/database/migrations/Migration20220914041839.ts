...
export class Migration20220914041839 extends Migration {
  ...
  async up(): Promise<void> {
    this.addSql('create table `users` (`id` int unsigned not null auto_increment primary key, `created_at` datetime not null, `updated_at` datetime not null, `email` varchar(255) not null, `password` varchar(255) not null, `first_name` varchar(255) null, `last_name` varchar(255) null) default character set utf8mb4 engine = InnoDB;');
    ...
    this.addSql('create table `refresh_tokens` (`id` int unsigned not null auto_increment primary key, `created_at` datetime not null, `updated_at` datetime not null, `user_id` int(11) unsigned not null, `is_revoked` json not null, `expires` datetime not null) default character set utf8mb4 engine = InnoDB;');
